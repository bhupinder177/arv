...
<div class="footer-middle">
            <div class="container">
                <div class="row">
                                ...
                                <div class="footer-widget address">
                                    ...
                                    <div class="footer-address">
                                        <div class="footer_s_inner">
                                            <div class="footer-sociala-icon"><i class="fa fa-home"></i></div>
                                ...
                                <div class="footer-widget address">
                                    ...
                                    <div class="footer-address">
                                        <div class="footer_s_inner">
                                            <div class="footer-sociala-icon"><i class="fa fa-home"></i></div>
                                            <div class="footer-sociala-info">
                                                <p><b>Head Office:</b> 27 Division St, New York, NY 10002, USA</p>
                                            </div>
                                        </div>
                                         ...
                                         <div class="footer_s_inner">
                                            <div class="footer-sociala-icon"><i class="fa fa-home"></i></div>
                                            <div class="footer-sociala-info">
                                                <p><b>Delhi Office: </b>7/8, Vardhman Ind Estate, Gawaripada Rd, Opp Arogya Niketan, Vasai (east)</p>
                                            </div>
                                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12last">
                        <div id="em_recent_post_widget-2" class="widget widget_recent_data">
                            <div class="single-widget-item">
                                <h2 class="widget-title"> social link
</h2>
                                <div class="recent-post-item">
                                   <div class="footer_s_inner">
                                        ...
                                        <div class="footer_s_inner">
                                            ...
                                            <div class="footer-sociala-info">
                                                <p><b>Email:</b> example@mail.com <b>Website:</b> yourwebsite.com</p>
                                            </div>
                                        </div>
                            ...
                            <div class="menu-social-menu-container">
                                <ul id="menu-social-menu" class="menu">
                                    ...
                                    <li id="menu-item-1215" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1215">
                                        <a href="#"><i class="fab fa-pinterest"></i></a>
                                    </li>
                                    <li id="menu-item-1216" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1216">
...
$(window).scroll(function(){
    if ($(this).scrollTop() > 50) {
       $('#dynamic').addClass('navigation-wrap2');
    } else {
       $('#dynamic').removeClass('navigation-wrap2');
    }
});
