...
<div class="page-content">
    <section class="content-header">
        <ol class="breadcrumb">
            <li class="active">knowledge-legals</li>
        </ol>
    </section>
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="searchpagelink" value="{{route('knowledge-legal.index')}}">
                            </div>
                        </div>
            ...
            <div class="col-md-6">
                <div class="refer-btn">
                     <a class="btn btn-rounded" href="{{route('knowledge-legal.add')}}">Add knowledge-legal</a>
                </div>
            </div>
        </div>
                    ...
                    if(count($allData) != 0){
                        ...
                        @foreach($allData as $u)
                            <tr class="data">
                                ...
                                <td>
                                      <img src="{{url('knowledge/'.$u->image)}}" width="150px;" />
                                </td>
                                <td >
                                    <a href="{{route('knowledge-legal.edit', ['id' => Crypt::encrypt($u->id)])}}"><i class="fa fa-edit"></i></a>
                                    <a class="deleterecord" data-link="{{route('knowledge-legal.delete')}}" data-id="{{$u->id}}"><i class="fa fa-trash deleterecord"  data-link="{{route('knowledge-legal.delete')}}"  data-id="{{$u->id}}" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        <?php
