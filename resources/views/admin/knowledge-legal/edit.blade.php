...
<div class="page-content">
    <section class="content-header">
        <ol class="breadcrumb">
            <li class="active">Edit Knowledge Legal</li>
        </ol>
    </section>
    <div class="container-fluid">
        <div class="">
            <form action="{{route('knowledge-legal.update')}}" method="post" enctype="multipart/form-data" class="reset general_form" id="addCommonEditor">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <img src="{{url('knowledge/'.$result->image)}}" width="150px;" />
                        </div>
                    </div>
