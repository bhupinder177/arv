      ...
      <section class="content-header">
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <input type="hidden" class="searchpagelink" value="{{URL::to($prefix.'/categories')}}">
              </div>
            </div>
            ...
            <div class="col-3 col-md-2">
              <div class="form-group">
            <a class="btn btn-success getreset" value="Reset" data-href="{{ url($prefix.'/categories') }}">Reset</a>
              </div>
            </div>
           </div>
          </form>--}}
          ...
          <div class="col-md-6">
            <div class="refer-btn">
                <a class="btn btn-rounded"  href="{{ url($prefix.'/categories-add')}}">Add Category</a>
            </div>
         </div>
       </div>
